...
var EvmWalletTopProfitableWalletPerTokenResponse = /** @class */ (function () {
    function EvmWalletTopProfitableWalletPerTokenResponse(input) {
        this.wallets = input.wallets.map(function (item) { return EvmTopProfitableWalletPerTokenResponse.create(item); });
    }
    ...
    EvmWalletTopProfitableWalletPerTokenResponse.fromJSON = function (json) {
        var input = {
            wallets: json.wallets.map(function (item) { return EvmTopProfitableWalletPerTokenResponse.fromJSON(item); }),
        };
    ...
    EvmWalletTopProfitableWalletPerTokenResponse.prototype.toJSON = function () {
        return {
            wallets: this.wallets.map(function (item) { return item.toJSON(); }),
        };
    };
